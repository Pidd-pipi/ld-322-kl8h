...
export interface Sensor { id: number; greenhouseId: number; name: string; type: SensorType; unit: string; status: SensorStatus; lastReportedAt?: string; threshold?: Threshold; }
