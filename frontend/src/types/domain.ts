...
export interface Sensor { id: number; greenhouseId: number; name: string; type: SensorType; unit: string; status: string; lastReportedAt?: string | null; threshold?: Threshold; }
